...
export default ({ show, setShow, user, service }) => {
    ...
    const handleRightDateClick = async() => {
      let mountDate = new Date(selectedYear, selectedMonth, 1);
      mountDate.setMonth(mountDate.getMonth() + 1);
      setSelectedYear(mountDate.getFullYear());
      setSelectedMonth(mountDate.getMonth());
            ...
            <ModalArea>
                ...
                <ModalItem>
                  ...
                  <DateList horizontal={true} showsHorizontalScrollIndicator={false}>
                    {listDays.map((item, key) => (
                       ...
                       style={{opacity: item.status ? 1 : 0.5, backgroundColor: item.number === selectedDay ? '#4EADBE' : '#ffff'}}
                       >
                ...
                <ModalItem>
                  ...
                  {listHours.map((item, key) => (
                    <TimeItem key={key}   onPress={() => setSelectedHour(item)} style={{backgroundColor: item === selectedHour ? '#4EADBE' : '#fff'}}>
                ...
                <FinishButton>
                  <FinishButtonText onPress={handleFinishClick}>Finalizar Agendamento</FinishButtonText>
                </FinishButton>
                </ModalBody>
            </ModalArea>
